...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        for($i = 0; $i < 9; $i++) {
            ...
            $description = "Ceci est la description de la figure numéro ".$i." ! N'hésitez pas à donner votre vais dans l'espace commentaire ci dessous !";
            ...
            $mediaPrincipal = $this->newImage(1000,400, $figure, null, true);
            ...
            for($j = 0; $j < 3; $j++) {
                $message = new Message();
                $content = "Ceci est le contenu de mon commentaire ! Super article !";
     ...
     * @return Media $media
     */
    public function newImage($width, $height, $figure = null, $forUser = false, $isFeaturedImage = false)
    {
        $media = new Media();
        $media->setName('User One Media');
        $media->setIsFeaturedImage($isFeaturedImage);
